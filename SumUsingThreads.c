...
diving second five numbers into another array void *second5(void *arg)
{
    int ans = 0;
    for(int i = 5; i < 10; i++)
    {
...
int main(void)
{
    ...
    pthread_create(&tids[1], NULL, second5,
                   (void *)NULL); // creating second thread to calculate sum of last five numbers
